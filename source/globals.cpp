...
std::vector<std::string> keywords = {"on ","template ","import ","unique ","new ","as ","catch","try","for ","in ","true","false",
    "if","else","register","method","pure","self","none"};
std::vector<std::string> classes = {"Rectangle","Window","String","Number","Boolean","List","Sprite","Image","Error","Exception",
